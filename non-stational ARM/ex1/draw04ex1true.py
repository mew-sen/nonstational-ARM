...
# 读取系数
##############################################################
coe_four = np.loadtxt(os.path.join(os.path.dirname(__file__), 'coe_H1_four.txt'))
...
true_sol = np.column_stack((X_vector,Y_vector,Z_vector))
np.savetxt('true_sol.txt', true_sol)
###########################################################################
##################           绘图并且比较两个图             #################
###########################################################################
